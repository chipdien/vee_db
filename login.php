...
<head>
    ...
    <!-- Bootstrap 4.0-->
    <link rel="stylesheet" href="<?= BASE ?>/assets/vendor_components/bootstrap/dist/css/bootstrap.min.css">

    <!-- Bootstrap extend-->
    <link rel="stylesheet" href="<?= BASE ?>/css/bootstrap-extend.css">

    <!-- Theme style -->
    <link rel="stylesheet" href="<?= BASE ?>/css/master_style.css">

    <!-- Superieur Admin skins -->
    <link rel="stylesheet" href="<?= BASE ?>/css/skins/_all-skins.css">
...
<body class="hold-transition bg-img" style="background-image: url(<?= BASE ?>/images/gallery/full/6.jpg)" data-overlay="4">
            ...
            <div class="row no-gutters justify-content-md-center">
                ...
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="p-40 bg-white content-bottom h-p100">
                        <form action="<?= BASE ?>/index.html" method="post" class="form-element">
...
<!-- jQuery 3 -->
<script src="<?= BASE ?>/assets/vendor_components/jquery-3.3.1/jquery-3.3.1.js"></script>

<!-- popper -->
<script src="<?= BASE ?>/assets/vendor_components/popper/dist/popper.min.js"></script>

<!-- Bootstrap 4.0-->
<script src="<?= BASE ?>/assets/vendor_components/bootstrap/dist/js/bootstrap.min.js"></script>
